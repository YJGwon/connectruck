...
ALTER TABLE truck ALTER COLUMN event_id BIGINT(20) NOT NULL;
ALTER TABLE menu ALTER COLUMN truck_id BIGINT(20) NOT NULL;
ALTER TABLE order_info ALTER COLUMN truck_id BIGINT(20) NOT NULL;
