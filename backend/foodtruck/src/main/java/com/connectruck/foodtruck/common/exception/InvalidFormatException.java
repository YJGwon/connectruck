...
public class InvalidFormatException extends ClientException {
    ...
    public InvalidFormatException(final String detail) {
        super(TITLE, detail);
    }
    ...
    public static InvalidFormatException withInputValue(final String parameterName, final String input) {
        return new InvalidFormatException(
                String.format(DETAIL_WITH_INPUT_VALUE_FORMAT, parameterName, input));
    }
    ...
    public static InvalidFormatException withFormatDescription(final String parameterName,
                                                               ...
                                                               final String input) {
        return new InvalidFormatException(
                String.format(DETAIL_WITH_FORMAT_DESCRIPTION_FORMAT, parameterName, formatDescription, input));
    }
}
