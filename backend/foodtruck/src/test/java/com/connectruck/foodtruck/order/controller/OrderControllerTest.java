...
class OrderControllerTest extends ControllerTestBase {
    ...
    class create {
        ...
        void returnBadRequest_whenTruckIdIsNull() throws Exception {
            // given
            final OrderRequest request = new OrderRequest(null, List.of(new OrderMenuRequest(1L, 2)));
        ...
        @ParameterizedTest
        @NullAndEmptySource
        void returnBadRequest_whenMenuIsBlank(final List<OrderMenuRequest> blank) throws Exception {
            // given
            final OrderRequest request = new OrderRequest(1L, blank);
        ...
        void returnBadRequest_whenMenuIdIsNull() throws Exception {
            // given
            final OrderRequest request = new OrderRequest(1L, List.of(new OrderMenuRequest(null, 2)));
        ...
        void returnBadRequest_whenQuantityIsNotPositive(final int quantity) throws Exception {
            // given
            final OrderRequest request = new OrderRequest(1L, List.of(new OrderMenuRequest(1L, quantity)));
